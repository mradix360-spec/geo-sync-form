...
import { FileText, Map, BarChart3, Settings, LogOut, Menu, X, Shield, FolderOpen, Sparkles, Package, ClipboardList } from "lucide-react";
...
const AnalystLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/analyst/tracking", icon: Package, label: "Assets" },
    { to: "/analyst/inspection", icon: ClipboardList, label: "Inspections" },
