  ...
  public: {
    Tables: {
      asset_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "asset_groups_organisation_id_fkey"
      ...
      dashboards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "dashboards_organisation_id_fkey"
            columns: ["organisation_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      maps: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "maps_organisation_id_fkey"
            columns: ["organisation_id"]
            isOneToOne: false
            referencedRelation: "organisations"
            referencedColumns: ["id"]
      ...
      shares: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shares_shared_with_user_fkey"
    ...
    Functions: {
      ...
      get_form_from_share_token: { Args: { p_token: string }; Returns: string }
      ...
      recalculate_all_staff_counts: { Args: never; Returns: undefined }
      st_3dclosestpoint: {
        Args: { geom1: unknown; geom2: unknown }
        Returns: unknown
      }
